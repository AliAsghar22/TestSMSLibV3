...
public class CommPortIdentifier
{
	...
	public int getPortType()
	{
		try
		{
			Method method = classCommPortIdentifier.getMethod("getPortType", (Class[]) null);
	...
	public String getName()
	{
		try
		{
			Method method = classCommPortIdentifier.getMethod("getName", (Class[]) null);
	...
	public static Enumeration<CommPortIdentifier> getPortIdentifiers()
	{
		...
		try
		{
			...
			Method method = classCommPortIdentifier.getMethod("getPortIdentifiers", (Class[]) null);
