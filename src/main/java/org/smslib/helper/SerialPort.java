...
public class SerialPort
{
	...
	public void close()
	{
		try
		{
			Method method = classSerialPort.getMethod("close", (Class[]) null);
	...
	public InputStream getInputStream()
	{
		try
		{
			Method method = classSerialPort.getMethod("getInputStream", (Class[]) null);
	...
	public OutputStream getOutputStream()
	{
		try
		{
			Method method = classSerialPort.getMethod("getOutputStream", (Class[]) null);
