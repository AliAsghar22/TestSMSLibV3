...
public class SerialPortEvent
{
	...
	public int getEventType()
	{
		...
		try
		{
			Method method = classSerialPortEvent.getMethod("getEventType", (Class[]) null);
	...
	public boolean getNewValue()
	{
		...
		try
		{
			Method method = classSerialPortEvent.getMethod("getNewValue", (Class[]) null);
	...
	public boolean getOldValue()
	{
		...
		try
		{
			Method method = classSerialPortEvent.getMethod("getOldValue", (Class[]) null);
